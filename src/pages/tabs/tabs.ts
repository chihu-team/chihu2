...
export class TabsPage {
  ...
  constructor(public appVersion: AppVersion, public UserService: UserServiceProvider, public platform: Platform, public navCtrl: NavController, public toastCtrl: ToastController) {
    setTimeout(()=>{
      this.pageBack();
    },1000);
  }
