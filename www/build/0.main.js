...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__personal__ = __webpack_require__(416);
...
PersonalPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__personal__["a" /* PersonalPage */]),
...
var PersonalPage = (function () {
    function PersonalPage(UserService, http, navCtrl, navParams) {
        this.UserService = UserService;
        this.http = http;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.isme = true;
        this.page1 = 'PersonalDetailsPage';
        this.page2 = 'PersonalHomePage';
        this._id = 0;
        this.chatParams = {
            _id: this._id,
            tar: null
    ...
    PersonalPage.prototype.getdata = function () {
        var _this = this;
...
PersonalPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_6" /* Component */])({
        selector: 'page-personal',template:/*ion-inline-start:"/Users/apple/Desktop/github/chihu2/src/pages/personal/personal.html"*/'<!--\n  Generated template for the PersonalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header no-border>\n\n    <ion-navbar color="mblue">\n        <ion-title><i class="fa fa-address-card" aria-hidden="true"></i></ion-title>\n        <ion-buttons [hidden]="isme" end>\n            <button (click)="chart();" ion-button icon-only>\n              <ion-icon name="text"></ion-icon>\n            </button>\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n    <section class="dv_top_ban">\n        <img [src]="userimg" />\n        <h2>{{name}}</h2>\n    </section>\n    <super-tabs height="100%" selectedTabIndex="0" tabColor="light" toolbarColor="light" indicatorColor="light" toolbarBackground="mblue" sliderColor="light">\n        <super-tab [root]="page1" [rootParams]="chatParams" title="详细信息"></super-tab>\n        <super-tab [root]="page2" [rootParams]="chatParams" title="个人主页"></super-tab>\n    </super-tabs>\n\n</ion-content>'/*ion-inline-end:"/Users/apple/Desktop/github/chihu2/src/pages/personal/personal.html"*/,
    }),
