...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SendSharePageModule", function() { return SendSharePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__send_share__ = __webpack_require__(424);
...
var SendSharePageModule = (function () {
    function SendSharePageModule() {
    }
    return SendSharePageModule;
}());
SendSharePageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__send_share__["a" /* SendSharePage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__send_share__["a" /* SendSharePage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__send_share__["a" /* SendSharePage */]
        ],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SendSharePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__ = __webpack_require__(327);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_transfer__ = __webpack_require__(321);
 ...
 */
var SendSharePage = (function () {
    function SendSharePage(http, transfer, navCtrl, navParams, actionSheetCtrl, camera, alertCtrl, UserService) {
        this.http = http;
    ...
    SendSharePage.prototype.send = function () {
        if (this.text.length) {
            this.postdata();
        }
        else {
    ...
    SendSharePage.prototype.postdata = function () {
        var _this = this;
        this.UserService.presentLoadingDefault();
        var url = "http://www.devonhello.com/chihu2/send_share";
    ...
    SendSharePage.prototype.up = function (path) {
        var _this = this;
        this.UserService.presentLoadingDefault();
    ...
    //长按删除事件
    SendSharePage.prototype.pressEvent = function (idx) {
        //alert(idx);
        this.showConfirm(idx);
    };
    //删除提示
    SendSharePage.prototype.showConfirm = function (idx) {
        var _this = this;
    ...
    SendSharePage.prototype.presentActionSheet = function () {
        var _this = this;
    ...
    //成品图片
    SendSharePage.prototype.seleImgType = function (type) {
        var _that = this;
...
//# sourceMappingURL=send-share.js.map
