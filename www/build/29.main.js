...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NoticeThankPageModule", function() { return NoticeThankPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__notice_thank__ = __webpack_require__(404);
...
var NoticeThankPageModule = (function () {
    function NoticeThankPageModule() {
    }
    return NoticeThankPageModule;
}());
NoticeThankPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__notice_thank__["a" /* NoticeThankPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__components_mes_item_mes_item_module__["a" /* MesItemComponentModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__notice_thank__["a" /* NoticeThankPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__notice_thank__["a" /* NoticeThankPage */]
        ]
    })
], NoticeThankPageModule);

//# sourceMappingURL=notice-thank.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NoticeThankPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(48);
 ...
 */
var NoticeThankPage = (function () {
    function NoticeThankPage(UserService, http, navCtrl, navParams) {
    ...
    NoticeThankPage.prototype.ionViewDidEnter = function () {
        this.getdata();
    };
    NoticeThankPage.prototype.getdata = function () {
        var _this = this;
        if (!this.UserService._user._id) {
            this.items = [];
            return true;
        }
        var url = "http://www.devonhello.com/chihu2/getthank";
    ...
    NoticeThankPage.prototype.open = function (artid, type) {
        switch (type) {
            case '0':
    ...
    NoticeThankPage.prototype.pushPersonPage = function (_id) {
        this.rootNavCtrl.push('PersonalPage', {
            _id: _id
        });
    };
    return NoticeThankPage;
}());
NoticeThankPage = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPage */])(),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_6" /* Component */])({
        selector: 'page-notice-thank',template:/*ion-inline-start:"/Users/apple/Desktop/github/chihu2/src/pages/notice/notice-thank/notice-thank.html"*/'<!--\n  Generated template for the NoticeNoticeThankPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-content [class.nomessage]="nomessage">\n\n    <ion-list>\n\n        <ion-item *ngFor="let item of items">\n            <ion-avatar item-left (click)="pushPersonPage( item.id )">\n                <img [src]="item.userimg">\n            </ion-avatar>\n            <div (click)="open( item.artid, item.type );">\n                <h2>{{item.conttext}}</h2>\n                <p>{{item.title}}</p>\n            </div>\n        </ion-item>\n\n\n    </ion-list>\n\n</ion-content>'/*ion-inline-end:"/Users/apple/Desktop/github/chihu2/src/pages/notice/notice-thank/notice-thank.html"*/,
    }),
...
//# sourceMappingURL=notice-thank.js.map
